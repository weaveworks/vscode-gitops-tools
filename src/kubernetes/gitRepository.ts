...
export interface GitRepository extends KubernetesObjectBase {
	...
	/** https://github.com/fluxcd/source-controller/blob/main/docs/api/source.md#gitrepositorystatus */
	readonly status: {
 ...
 * https://github.com/fluxcd/source-controller/blob/main/docs/api/source.md#gitrepositoryref
 */
 ...
 * https://github.com/fluxcd/source-controller/blob/main/docs/api/source.md#gitrepositoryverification
 */
 ...
 * https://github.com/fluxcd/source-controller/blob/main/docs/api/source.md#gitrepositoryinclude
 */
