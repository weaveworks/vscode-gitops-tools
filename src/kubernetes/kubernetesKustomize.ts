import { KubernetesDeploymentCondition, KubernetesJSON, KubernetesLocalObjectReference, KubernetesObjectBase, KubernetesObjectMeta, ResultMetadata } from './kubernetesGeneralTypes';
...
export interface Kustomize extends KubernetesObjectBase {
	...
	/** https://github.com/fluxcd/kustomize-controller/blob/main/docs/api/kustomize.md#kustomizationstatus */
	readonly status: {
...
/**
 * PostBuild describes which actions to perform on the YAML manifest generated
 * by building the kustomize overlay.
 */
interface PostBuild {
	/**
