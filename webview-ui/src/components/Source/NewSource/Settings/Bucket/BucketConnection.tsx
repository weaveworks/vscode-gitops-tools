...
function BucketConnection() {
	return (
		<div>
			...
			<div>
				<label><code>Secret</code> with authentication credentials (TLS, basic auth or docker-secret) <a href="https://fluxcd.io/flux/components/source/Bucketrepositories/#secret-reference">?</a></label>
			...
			<div style="margin-bottom: 1rem">
				<vscode-checkbox use:bindCheckedValueFunc={(checked: boolean) => setSource('BucketPassCredentials', checked)}>
						Pass credentials to all domains (HTTP/S repositories only) <a href="https://fluxcd.io/flux/components/source/Bucketrepositories/#pass-credentials">?</a>
				</vscode-checkbox>
			</div>
